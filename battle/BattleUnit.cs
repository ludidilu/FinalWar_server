...
internal class BattleUnit
{
    ...
    internal void Init(int _mPlayer, int _oPlayer, int[] _mCards, int[] _oCards, int _battleInitDataID, bool _isVsAi)
    {
        mPlayer = _mPlayer;
        oPlayer = _oPlayer;
        ...
        battle.ServerStart(_battleInitDataID, _mCards, _oCards, isVsAi);
    }
